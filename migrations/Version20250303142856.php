 ...
 */
final class Version20250303142856 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, campus_id INT NOT NULL, first_name VARCHAR(30) NOT NULL, last_name VARCHAR(30) NOT NULL, phone VARCHAR(15) NOT NULL, email VARCHAR(50) NOT NULL, roles JSON NOT NULL, administrator TINYINT(1) NOT NULL, password VARCHAR(255) NOT NULL, active TINYINT(1) NOT NULL, username VARCHAR(50) NOT NULL, profile_picture VARCHAR(255) DEFAULT NULL, INDEX IDX_8D93D649AF5D55E1 (campus_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
