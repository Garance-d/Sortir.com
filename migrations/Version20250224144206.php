 ...
 */
final class Version20250224144206 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hangout CHANGE registration_end_at registration_ends_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hangout CHANGE registration_ends_at registration_end_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    }
}
